...
## Packaged minimal app

For a smaller starting point, `bs4dashkit_example_app()` returns the same
recommended `dash_titles()` plus `use_bs4Dashkit_core()` flow as a runnable
`shiny.appobj`:
...
Pass `layout = "topnav"` for a minimal top-navigation demo instead of the
sidebar layout:
